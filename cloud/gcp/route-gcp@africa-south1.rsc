/ip firewall address-list remove [/ip firewall address-list find list="route-gcp@africa-south1"]
/ip firewall address-list
add address=34.1.208.0/20 disabled=no list=route-gcp@africa-south1
